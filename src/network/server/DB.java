...
public enum DB {
	// Account & other
	PLAYERS_WHITELISTED("id INT NOT NULL AUTO_INCREMENT, uuid VARCHAR(40), name VARCHAR(16), PRIMARY KEY(id)"),
	...
	PLAYERS_CUSTOMERS("id INT NOT NULL AUTO_INCREMENT, uuid VARCHAR(40), product VARCHAR(30), PRIMARY KEY(id)"),
	PLAYERS_RECENT_VOTER("id INT NOT NULL AUTO_INCREMENT, uuid VARCHAR(40), date TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP, PRIMARY KEY(id)"),
	PLAYERS_DISCORD("id INT NOT NULL AUTO_INCREMENT, uuid VARCHAR(40), discord VARCHAR(30), PRIMARY KEY(id)"),
...
//	NETWORK_RECENT_CUSTOMERS("id INT NOT NULL AUTO_INCREMENT, uuid VARCHAR(40), package VARCHAR(50), PRIMARY KEY(id)"),
	...
	NETWORK_UHC_KICKS("id INT NOT NULL AUTO_INCREMENT, uuid VARCHAR(40), staff_uuid VARCHAR(40), reason VARCHAR(255), PRIMARY KEY(id)"),
	NETWORK_UHC_KILLS("id INT NOT NULL AUTO_INCREMENT, uuid VARCHAR(40), staff_uuid VARCHAR(40), reason VARCHAR(255), PRIMARY KEY(id)"),
